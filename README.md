...
[![GitHub stars](https://img.shields.io/github/stars/Alpha-Park/genpark-minimax-alpha-beta-adversarial-search-skill?style=social)](https://github.com/Alpha-Park/genpark-minimax-alpha-beta-adversarial-search-skill/stargazers)
...
```bash
git clone https://github.com/Alpha-Park/genpark-minimax-alpha-beta-adversarial-search-skill.git
